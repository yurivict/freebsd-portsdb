...
ALL_VARS="PKGORIGIN PORTNAME PORTVERSION DISTVERSION DISTVERSIONPREFIX DISTVERSIONSUFFIX PORTREVISION PKGNAME MAINTAINER WWW COMMENT PKGBASE BUILD_DEPENDS RUN_DEPENDS TEST_DEPENDS"
